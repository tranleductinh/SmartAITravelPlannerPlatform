...
const mockProviders = [
  {
    ...
    description: "Specializing in high-altitude trekking and luxury basecamp experiences across the Swiss Alps.",
    status: "new",
    logoUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuA_SaGAk79jB4iPaIILNisKZHe3NoIeLNXN2ha1eR1tk7QFencsbo3JNDYx2j1Isdc2FMRxGw9u-SeYxwJR9FXARahUXVaXzbFwq6GSg71HiPR1I0YPcHz9BWrPwJuXLEHzKy-jxDa1wDz5z5LaXFbfrud-GJ_AXxUTMjb-Y5VKTJEBjfZ-hAH7HDJ8r_pjOxnP64KDyqSdbif_MteWMtdazuE1djydDaG8yVQQ88ZtbDUVSLvIWQ9yw2oPTAFydL4qfNa5IpD3N4Mj",
    documents: [
  ...
  },
  {
    ...
    description: "Premium Mediterranean yacht rentals with fully-staffed crews and bespoke coastal itineraries.",
    status: "urgent",
    logoUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuCfqMHhXRIm_qAefyf2KTf66IKp9T5V6EGcfh_TixkeMLHJJLrH17OsVOwXdHKH7FejURnAnNRcd7kd6hmwGSNuzEjH0LUn63HtTUg9ZaJt3_onQCqoyD9IIqJX7TXI9mY6Oir_HIo9chyyjaCL3kU-a9SMmsuXS8Q0QSNYRFrvv_oFI4lRsfABkaM008Pw32SKM2lHBzPsunPkRW37gCZt6u_9jZgZO1NL6-LTF7IDUhW9FyAf-u3Vv-SklNKGCB1HMyEZe3V0nUej",
    documents: [
...
const ProviderApprovalPage = () => {
  ...
  return (
    <div className="mt-16 p-8 space-y-12 max-w-[1400px] mx-auto">
      ...
      <section>
        ...
        <p className="text-slate-500 mt-2 max-w-2xl text-sm">
          Examine business credentials and verification documents for providers requesting access to the marketplace.
        </p>
      </section>
      ...
      <section className="grid grid-cols-1 xl:grid-cols-12 gap-8">
        ...
        <div className="xl:col-span-4 space-y-6">
          ...
          <Card className="bg-slate-900 border-none text-white relative overflow-hidden rounded-2xl shadow-xl">
            ...
            <CardContent className="space-y-8 relative z-10">
              <div>
                ...
                <p className="text-sm opacity-70 mt-1">Provider Approval Rate (MTD)</p>
                
                <Progress 
                  value={88} 
                  className="h-1.5 mt-4 bg-white/10" 
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                  ...
                  <p className="text-[10px] opacity-50 font-bold uppercase mt-1">New This Week</p>
                </div>
                <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                  <p className="text-2xl font-bold font-headline">4.2d</p>
                  <p className="text-[10px] opacity-50 font-bold uppercase mt-1">Avg. Review Time</p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="bg-slate-50/50 border-slate-100 rounded-2xl">
            <CardHeader>
              <CardTitle className="text-sm font-bold text-slate-900 uppercase tracking-wide">Verification Guidelines</CardTitle>
            </CardHeader>
